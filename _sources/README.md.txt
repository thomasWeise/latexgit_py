...
It also installs the [dependencies for building](./requirements-dev_txt.html), which include, e.g., those for unit testing and static analysis.
If this build completes successful, you can be sure that [`latexgit`](./) will work properly on your machine.

All dependencies for using and running `latexgit` are listed at [here](./requirements_txt.html).
...
`latexgit` is provided to the public as open source software under the [GNU GENERAL PUBLIC LICENSE, Version 3, 29 June 2007](./LICENSE.html).
...
Please visit the [contributions guidelines](./CONTRIBUTING_md.html) for `latexgit` if you would like to contribute to our package.
